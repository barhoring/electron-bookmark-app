...
let tmp = Object.keys(systemPreferences);
console.log(Object.keys(systemPreferences));
console.log(systemPreferences.isInvertedColorScheme());
console.log(systemPreferences[1]);
console.log(systemPreferences[2]);
...
window.addEventListener("load", () => {
  if (systemPreferences.isDarkMode()) {
    ...
    // systemPreferences.eventNames(e => console.log("bar"));
